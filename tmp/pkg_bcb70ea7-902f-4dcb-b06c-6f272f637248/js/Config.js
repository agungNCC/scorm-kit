...
var Config = {
    ...
    pptUrl: "https://netpolitanteam.com/demo/ppt/test.pdf",


    // (opsional) fallback ke file PDF statis di folder `data/` kalau tidak mau convert
    filename: null, // contoh: "sample.pdf"
